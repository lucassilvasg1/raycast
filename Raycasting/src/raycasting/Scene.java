...
public class Scene
{
   ...
   public Scene()
   {
      ...
      primitives.add(createCylinder(-140, -30, 400, 6, 70, 0xf4d58c)); //p�s da sinuca
      ...
      primitives.add(createBox(-478, 112, -107, -474, 114, -112, 0xebfffd));//Bra�o do copo
      ...
      primitives.add(createBox(-486, 112, -7, -482, 114, -12, 0xebfffd));//Bra�o do copo
      ...
      primitives.add(createBox(-482, 112, 93, -478, 114, 88, 0xebfffd));//Bra�o do copo
      ...
      primitives.add(createBox(-490, 112, 193, -486, 114, 188, 0xebfffd));//Bra�o do copo
      ...
      primitives.add(createBox(-478, 112, 293, -474, 114, 288, 0xebfffd));//Bra�o do copo
      ...
      primitives.add(createCylinder(-80, -30, 780, 3, 40, 0xf4d58c)); //p�s da mesa
      ...
      primitives.add(createBox(-180, -30, 990, -150, 40, 860, 0xf4d58c)); //bra�os
      ...
      primitives.add(createBox(200, -30, 830, 330, 40, 800, 0xf4d58c)); //bra�os
      ...
      primitives.add(createBox(-330, -30, 830, -200, 40, 800, 0xf4d58c)); //bra�os
